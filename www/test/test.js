...
describe("OpenPGP.js", () => {
    ...
    it("Binary sign", async () => {
        ...
        await openpgp.verify({
            message: openpgp.message.fromBinary(data),
            signature: await openpgp.signature.readArmored(sign.signature),
            publicKeys: [pubkey],
        }).then(async (verify) => {
...
describe("Protobuf & OpenPGPJs", () => {
    ...
    it("Signed Protobuf",async () => {
        ...
        signedMsg.setFingerprint(openpgp.util.Uint8Array_to_hex(pubkey.primaryKey.fingerprint))
        ...
        console.log(obj.getFingerprint())
